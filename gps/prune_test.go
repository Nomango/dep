	...
	}{
		{
			...
			co: CascadingPruneOptions{
				...
				PerProjectOptions: map[ProjectRoot]PruneOptionSet{
					ProjectRoot("github.com/nomango/dep"): {},
				},
			},
			results: map[ProjectRoot]PruneOptions{
				ProjectRoot("github.com/nomango/dep"): PruneNestedVendorDirs,
			},
		},
		{
			name: "all overridden",
			...
			results: map[ProjectRoot]PruneOptions{
				ProjectRoot("github.com/nomango/dep"): PruneUnusedPackages | PruneNonGoFiles | PruneGoTestFiles,
			},
		},
		{
			name: "all redundant",
