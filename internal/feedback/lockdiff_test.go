...
func TestDiffProjects_NoChange(t *testing.T) {
	p1 := gps.NewLockedProject(mkPI("github.com/nomango/dep/gps"), gps.NewVersion("v0.10.0"), []string{"gps"})
	p2 := gps.NewLockedProject(mkPI("github.com/nomango/dep/gps"), gps.NewVersion("v0.10.0"), []string{"gps"})
